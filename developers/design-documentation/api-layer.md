...
The current plugin inventory is 35. Authentication shape varies by broker, and capability metadata is the correct way for UI code to discover supported exchanges and features.
...
See [40 Logout And Session Lifecycle](40-logout-and-session-expiry.md) for the expiry and heartbeat state machine.
