...
Click on the **Generate API Keys** dropdown and select Generate TOTP token and Select API Key and Secret an Enter the Token Name as "OpenAlgo" or any name of your choice and press **continue**
