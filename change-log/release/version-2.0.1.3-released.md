...
* `openalgo` SDK pin: `1.0.51` → `2.0.0` → **`2.0.1`** (PyPI: [https://pypi.org/project/openalgo/](https://pypi.org/project/openalgo/)).
...
* **@Minh\_Nguyen** — reusable EmptyState component (#1484).
