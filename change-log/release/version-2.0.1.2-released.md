...
* Available at [https://pypi.org/project/openalgo/1.0.51/](https://pypi.org/project/openalgo/1.0.51/).
...
* `openalgo` SDK pin: `1.0.50` → `1.0.51` (PyPI: [https://pypi.org/project/openalgo/1.0.51/](https://pypi.org/project/openalgo/1.0.51/)) — connection-pooling fix.
* `idna` `3.11` → `3.15`.
...
* **Python SDK on PyPI**: [https://pypi.org/project/openalgo/1.0.51/](https://pypi.org/project/openalgo/1.0.51/)
