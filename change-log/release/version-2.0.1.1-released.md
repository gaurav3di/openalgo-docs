...
* Available at [https://pypi.org/project/openalgo/1.0.50/](https://pypi.org/project/openalgo/1.0.50/)
...
* `openalgo` SDK pin: `1.0.49` → `1.0.50` (PyPI: [https://pypi.org/project/openalgo/1.0.50/](https://pypi.org/project/openalgo/1.0.50/))
...
* **Python SDK on PyPI**: [https://pypi.org/project/openalgo/1.0.50/](https://pypi.org/project/openalgo/1.0.50/)
* **WhatsApp service docs**: [https://docs.openalgo.in/api-documentation/v1/whatsapp-services](https://docs.openalgo.in/api-documentation/v1/whatsapp-services)
